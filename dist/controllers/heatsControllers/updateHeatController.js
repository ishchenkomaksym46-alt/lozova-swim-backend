...
export default async function updateHeatController(c) {
    ...
    try {
        ...
        const service = await heatsService.updateHeat(heatNum, distanceNum, body.newHeatNumber, body.participants);
        if (service.success) {
