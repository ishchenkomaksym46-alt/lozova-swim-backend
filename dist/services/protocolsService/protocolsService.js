...
export const protocolsService = {
    async getProtocols(competitionId, page) {
        try {
            const limit = 10;
    ...
    async createProtocol(competitionId, header, text) {
        try {
    ...
    async updateProtocol(oldHeader, newHeader, text) {
        try {
