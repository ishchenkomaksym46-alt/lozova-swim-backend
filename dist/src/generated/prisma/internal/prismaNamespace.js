...
export const DistancesScalarFieldEnum = {
    id: 'id',
    name: 'name',
...
export const EntryItemsScalarFieldEnum = {
    id: 'id',
    entryId: 'entryId',
    name: 'name',
    surname: 'surname',
...
export const HeatsScalarFieldEnum = {
    id: 'id',
...
export const ResultsScalarFieldEnum = {
    ...
    time: 'time',
    place: 'place',
    placeInHeat: 'placeInHeat',
    createdAt: 'createdAt',
    updatedAt: 'updatedAt'
};
export const SwimmersScalarFieldEnum = {
    id: 'id',
    name: 'name',
    surname: 'surname',
    birthYear: 'birthYear',
