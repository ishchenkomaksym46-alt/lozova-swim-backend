...
export default async function updateEntryController(c: Context) {
    ...
    if (birthYear) updateData.birthYear = Number(birthYear);
    if (seedTime) updateData.seedTime = seedTime;
